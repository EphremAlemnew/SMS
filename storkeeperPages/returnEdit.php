    ...
    <div class="container col-md-6">
        <form method="post" class="row g-4">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="reason" value="<?php echo $reason ?>" id="validationServer01" required>
            </div>
            <div class="col-md-6">
                <label for="validationServer01" class="form-label">Purchased By</label>
                <input type="text" class="form-control" name="pBy" value="<?php echo $pBy ?>" id="validationServer01" required>
            </div>
            <div class="col-6">
                <input type="submit" name="submit" value="Update" class="btn btn-primary">
            </div>
            <div class="col-6">
            <a href="./storeReturnPage.php" class="btn btn-secondary" > Cancel</a>
