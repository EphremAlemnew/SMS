...
<body>
    ...
    <div  class="card-tools" style="align-self: flex-end;">
			<a href="./addingNewPurch.php" style="align-self: flex-end;" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Add New</a>
		</div>
	<div class="card-body">
    ...
    if($qry->num_rows > 0){
        while($row = $qry->fetch_assoc()):
            // Debugging statement to check the row data
...
?>
            <tr>
                ...
                <td><p class="m-0"><?php echo $row['appByManager'] == 0 ? 'NO' : 'YES'; ?></p></td>
                <td><p class="m-0"><?php echo $row['pname'] == '' ? 'NOT ASSIGNED' : $row['pname']; ?></p></td>
                <td><p class="m-0"><?php echo $row['Purchased'] == 0 ? 'NOT PURCHASED' : 'PURCHASED'; ?></p></td>
                <td>
                    <div class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-expanded="false">Action</a>
                        <ul class="dropdown-menu">
                            <a href="#" class="dropdown-item btn btn-primary"><span class="d-inline-block bg-success rounded-circle p-1"></span> Edit</a>
                            <a href="#" class="dropdown-item btn btn-danger"><span class="d-inline-block bg-danger rounded-circle p-1"></span> Delete</a>
                            <a href="./receiveStock.php?id=<?php echo $row['id']; ?>" class="dropdown-item btn btn-secondary"><span class="d-inline-block bg-secondary rounded-circle p-1"></span> Received</a>
                        </ul>
                    </div>
                </td>
            </tr>
