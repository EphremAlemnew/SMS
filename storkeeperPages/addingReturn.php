...
if($_SERVER['REQUEST_METHOD']=='GET' && isset($_GET['id'])){
    ...
    $insert = "INSERT INTO `returns` (`id`, `code`, `name`, `description`, `purdate`, `expdate`, `amount`, `reason`, `purby`) VALUES (NULL, '$itemId', '$itemName', '$itemDesc', '$itemPdate', '$itemEdate', '$amount', '$reason', '$pBy');";
...
<body>
    ...
    <div class="container col-md-6">
        <form method="post" class="row g-4">
            ...
            ?>
            <h3 style="text-align:center; margin-top:5%" class="alert alert-dark">Returning Item</h3>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <label for="validationServer01" class="form-label">Returning reason</label>
                <input type="text" class="form-control" name="reason" id="validationServer01" required>
            </div>
            <div class="col-md-6">
                <label for="validationServer01" class="form-label">Purchased By</label>
                <input type="text" class="form-control" name="pBy" id="validationServer01" required>
            </div>
            <div class="col-6">
