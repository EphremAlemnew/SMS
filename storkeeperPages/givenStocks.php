...
<body>
	...
	<div style="align-content: center;" class="card-header ">
		<h3 style="align-self: center;" class="card-title">List of Given Items</h3>
	</div>
	...
	<div class="card-body">
        ...
        LEFT JOIN 
            ...
            <ul class="dropdown-menu">
                 <a  href="./deleteStock.php?id=<?php echo $row['id']?>" class="dropdown-item btn btn-secondary"><span class="d-inline-block bg-secondary rounded-circle p-1"></span>Approve</a>
					...
					<?php endwhile; }
						...
						echo '<h2>Sorry, No Items were given!<h2/>';
					}?>
				</tbody>
			</table>
		</div>
