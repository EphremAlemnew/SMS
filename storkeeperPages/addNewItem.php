...
if(isset($_POST['submit'])){
    ...
    $select = " SELECT * FROM stock WHERE code = '$itemId' ";
...
<body>
   ...
   <?php
      ...
      ?>
      <h3 style="text-align:center; margin-top:5%"  class="alert alert-dark">Add new item</h3>
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control " name="Pdate" id="validationServer02"  required>
            
          </div>
          <div class="col-md-6">
            <label for="validationServer01" class="form-label">Expire Date</label>
            <input type="text" class="form-control " name="Edate" id="validationServer01" v required>
