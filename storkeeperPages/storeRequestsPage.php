	...
	<div class="card-body">
        ...
        LEFT JOIN 
            ...
            <ul class="dropdown-menu">
                 <a  href="./giveStock.php?id=<?php echo $row['id']?>" class="dropdown-item btn btn-secondary"><span class="d-inline-block bg-secondary rounded-circle p-1"></span>Approve</a>
