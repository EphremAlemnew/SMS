...
/* =============== Globals ============== */
    ...
    <?php @include('./header.php');?>
      ...
      ?>
        ...
        <?php }else{
         ...
         <a href="./managerStockPage.php" style="text-decoration: none;" class="col-md-3 mb-3">
  ...
  <div class="row">
    ...
    <div class="col-md-4"> <h1><?php 
         ...
         <a href="./managerReturnPage.php" style="text-decoration: none;" class="col-md-3 mb-3">
  ...
  <div class="card-body">
    ...
    <div class="col-md-4"> <h1><?php 
         ...
         <a href="./managerPurPage.php" style="text-decoration: none;" class="col-md-3 mb-3">
  ...
  <div class="row">
    ...
    <div class="col-md-4"> <h1><?php 
         ...
         <a href="./managerRequestsPage.php" style="text-decoration: none;" class="col-md-3 mb-3">
