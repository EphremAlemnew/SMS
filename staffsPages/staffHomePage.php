...
/* =============== Globals ============== */
    ...
    <?php @include('./header.php');?>
      ...
      ?>
        ...
        <?php }else{
         ...
         <a href="./staffStock.php" style="text-decoration: none;" class="col-md-3 mb-3">
  ...
  <div class="row">
    ...
    <div class="col-md-4"> <h1><?php 
                    echo $conn->query("SELECT * from `requests` Where `appByStore`=1 AND `appByReq`=1 AND `requestedBy`='$id';")->num_rows;
                ?></h1></div>
    </div>
  </div>
</div>
         </a>
         <a href="./staffRequests.php" style="text-decoration: none;" class="col-md-3 mb-3">
  ...
  <div class="row">
    ...
    <div class="col-md-4"> <h1><?php 
                    echo $conn->query("SELECT * FROM `requests` WHERE `appByReq`=0 AND `requestedBy`='$id' ;")->num_rows;
                ?></h1></div>
    </div>
  </div>
</di>
