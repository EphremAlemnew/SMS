        ...
        <div class="container-fluid">
			<table class="table table-hover table-striped">
				...
				<tbody>
					<?php 
						$i = 1;
						$qry = $conn->query("SELECT * from `purchasing` where `purchaser`='$id' ");
						if($qry->num_rows > 0){
            ...
            <ul class="dropdown-menu">
                 <a  href="./setPurchased.php?id=<?php echo $row['id']?>" class="dropdown-item btn btn-secondary"><span class="d-inline-block bg-secondary rounded-circle p-1"></span> Set as PURCHASED?</a>
