...
/* =============== Globals ============== */
    ...
    <?php @include('./header.php');?>
      ...
      ?>
        ...
        <?php }else{
         ...
         <a href="./purPurchasing.php" style="text-decoration: none;" class="col-md-3 mb-3">
  ...
  <div class="row">
    ...
    <div class="col-md-4"> <h1><?php 
                    echo $conn->query("SELECT * from `purchasing` where `purchaser`='$id';")->num_rows;
                ?></h1></div>
    </div>
  </div>
</div>
         </a>
         <a href="./purReturn.php" style="text-decoration: none;" class="col-md-3 mb-3">
  ...
  <div class="card-body">
    ...
    <div class="col-md-4"> <h1><?php 
                    echo $conn->query("SELECT * from `returns` WHERE `purby`='$id';")->num_rows;
                ?></h1></div>
    </div>
